...
export const metadata: Metadata = {
  ...
  description: "Haber Nexus kullanım koşulları. Platformumuzu kullanırken uymanız gereken kurallar ve şartlar.",
}
        ...
        <section className="container py-16">
          <div className="max-w-4xl mx-auto space-y-8">
            <Card>
              ...
              <CardContent className="space-y-4">
                <p className="text-sm text-muted-foreground leading-relaxed">
                  Bu Kullanım Koşulları, Haber Nexus (&quot;Platform&quot;, &quot;Biz&quot;, &quot;Bizim&quot;) web sitesini ve 
                  hizmetlerini kullanımınızı düzenler. Platformumuzu kullanarak bu koşulları kabul 
                  etmiş sayılırsınız.
                </p>
                <p className="text-sm text-muted-foreground leading-relaxed">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div>
                  <h3 className="font-semibold mb-2 text-sm">3.1. Hesap Oluşturma</h3>
                  <p className="text-sm text-muted-foreground leading-relaxed">
                    Platformumuzun bazı özelliklerini kullanmak için bir hesap oluşturmanız gerekebilir. 
                    Hesap oluştururken doğru, güncel ve eksiksiz bilgiler vermeyi kabul edersiniz.
                  </p>
                </div>

                <div>
                  <h3 className="font-semibold mb-2 text-sm">3.2. Hesap Güvenliği</h3>
                  <p className="text-sm text-muted-foreground leading-relaxed">
                    Hesabınızın güvenliğinden siz sorumlusunuz. Şifrenizi gizli tutmalı ve hesabınızda 
                    gerçekleşen tüm faaliyetlerden sorumlu olduğunuzu kabul edersiniz.
                  </p>
                </div>

                <div>
                  <h3 className="font-semibold mb-2 text-sm">3.3. Hesap Askıya Alma</h3>
                  <p className="text-sm text-muted-foreground leading-relaxed">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <ul className="list-disc list-inside text-sm text-muted-foreground space-y-2 ml-4">
                  <li>Yasadışı, zararlı, tehditkar, taciz edici, hakaret içeren içerik paylaşmak</li>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div>
                  <h3 className="font-semibold mb-2 text-sm">5.1. Platform İçeriği</h3>
                  <p className="text-sm text-muted-foreground leading-relaxed">
                    Platformdaki tüm içerik (haberler, makaleler, görseller, tasarım, logo, kod) 
                    Haber Nexus&apos;a veya lisans verenlerine aittir ve telif hakkı yasalarıyla korunmaktadır.
                  </p>
                </div>

                <div>
                  <h3 className="font-semibold mb-2 text-sm">5.2. Kullanıcı İçeriği</h3>
                  <p className="text-sm text-muted-foreground leading-relaxed">
                    Platformda paylaştığınız içerik (yorumlar, profil bilgileri) üzerindeki haklarınızı 
                    korursunuz, ancak bu içeriği platformumuzda kullanmamız için bize dünya çapında, 
                    telifsiz, alt lisanslanabilir bir lisans vermiş olursunuz.
                  </p>
                </div>

                <div>
                  <h3 className="font-semibold mb-2 text-sm">5.3. Telif Hakkı İhlalleri</h3>
                  <p className="text-sm text-muted-foreground leading-relaxed">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <p className="text-sm text-muted-foreground leading-relaxed">
                  Platformumuz, haber analizi ve özetleme için yapay zeka (Google Gemini AI) kullanmaktadır. 
                  AI tarafından üretilen içerikler:
                </p>
                <ul className="list-disc list-inside text-sm text-muted-foreground space-y-2 ml-4">
                ...
                <p className="text-sm text-muted-foreground leading-relaxed mt-4">
                  AI tarafından üretilen içeriklerin doğruluğunu garanti etmiyoruz ve bu içeriklerden 
                  kaynaklanan zararlardan sorumlu değiliz.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <p className="text-sm text-muted-foreground leading-relaxed">
                  Platform &quot;olduğu gibi&quot; ve &quot;mevcut olduğu şekilde&quot; sunulmaktadır. Aşağıdaki konularda 
                  garanti vermiyoruz:
                </p>
                <ul className="list-disc list-inside text-sm text-muted-foreground space-y-2 ml-4">
                ...
                <p className="text-sm text-muted-foreground leading-relaxed mt-4">
                  Platformun kullanımından kaynaklanan doğrudan veya dolaylı zararlardan sorumlu değiliz.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground leading-relaxed">
                  ...
                  yalnızca kolaylık sağlamak amacıyla verilmiştir. Üçüncü taraf sitelerin içeriğinden 
            ...
            <div className="bg-muted/50 p-6 rounded-lg border">
              <p className="text-sm text-muted-foreground leading-relaxed">
                <strong>Önemli Not:</strong> Bu Kullanım Koşullarını düzenli olarak gözden geçirmenizi 
                öneririz. Platformu kullanmaya devam ederek güncel koşulları kabul etmiş sayılırsınız.
              </p>
            </div>
          </div>
        </section>
