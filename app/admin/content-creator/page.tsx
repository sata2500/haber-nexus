...
export default function ContentCreatorPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      <h1 className="text-3xl font-bold mb-8">🤖 AI İçerik Oluşturucu</h1>
        ...
        <div className="bg-white rounded-lg shadow-md p-6 space-y-6">
          ...
          <div className="flex items-center">
            <input
              ...
              className="mr-2"
            />
            <label htmlFor="includeResearch" className="text-sm text-gray-700">
      ...
      {step === 2 && generatedContent && (
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            <h2 className="text-xl font-bold mb-4">Kalite Skorları</h2>
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <p className="text-gray-600 mb-4">{generatedContent.excerpt}</p>
            ...
            <div className="mt-6 pt-6 border-t">
              ...
              <div className="mt-2">
                <strong className="text-sm text-gray-600">Etiketler:</strong>{" "}
